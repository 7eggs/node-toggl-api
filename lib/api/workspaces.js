...
TogglClient.prototype.getWorkspaceClients = function getWorkspaceClients(wId,
  callback) {
  return this.apiRequest('/api/v9/workspaces/' + wId + '/clients', {}, callback);
};
...
TogglClient.prototype.getWorkspaceData = function getWorkspaceData(wId,
  callback) {
  return this.apiRequest('/api/v9/workspaces/' + wId, {},
...
TogglClient.prototype.getWorkspaceProjects = function getWorkspaceProjects(wId,
  ...
  return this.apiRequest('/api/v9/workspaces/' + wId + '/projects', req, callback);
};
...
TogglClient.prototype.getWorkspaceTags = function getWorkspaceTags(wId,
  callback) {
  return this.apiRequest('/api/v9/workspaces/' + wId + '/tags', {}, callback);
};
...
TogglClient.prototype.getWorkspaceTasks = function getWorkspaceTasks(wId,
  ...
  return this.apiRequest('/api/v9/workspaces/' + wId + '/tasks', req, callback);
};
...
TogglClient.prototype.getWorkspaceUsers = function getWorkspaceUsers(wId,
  ...
  return this.apiRequest(`/api/v9/workspaces/${wId}/users`, {}, callback);
};
...
TogglClient.prototype.getWorkspaces = function getWorkspaces(callback) {
  return this.apiRequest('/api/v9/workspaces', {}, callback);
};
...
TogglClient.prototype.updateWorkspace = function updateWorkspace(wId, data, callback) {
  ...
  return this.apiRequest('/api/v9/workspaces/' + wId, req,
    utils.wrapDataCallback(callback));
};
