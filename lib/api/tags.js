 ...
 * @public
 * @param {Number|String} workspaceId Workspace Id
 * @param {Number[]} teId Time entry Id
 ...
 * @public
 */
TogglClient.prototype.addTimeEntriesTags = function (workspaceId, teIds, tags, callback) {
  this.updateTimeEntriesTags(workspaceId, teIds, tags, 'add', callback);
};
 ...
 * @public
 */
TogglClient.prototype.removeTimeEntriesTags = function (workspaceId, teIds, tags, callback) {
  this.updateTimeEntriesTags(workspaceId, teIds, tags, 'remove', callback);
};
