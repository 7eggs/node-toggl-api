...
TogglClient.prototype.getTags = function getTags(workspaceId, callback) {
  return this.apiRequest(`workspaces/${workspaceId}/tags`, {}, utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.createTag = function createTag(name, workspaceId, callback) {
  ...
  return this.apiRequest(`workspaces/${workspaceId}/tags`, req, utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.updateTagName = function updateTagName(tagId, workspaceId, name,
  ...
  return this.apiRequest(`workspaces/${workspaceId}/tags/${tagId}`, req,
