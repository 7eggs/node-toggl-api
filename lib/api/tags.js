 ...
 * @param {Function} callback <code>(err, tag)</code>
 */
TogglClient.prototype.createTag = function createTag(workspaceId, name, callback) {
  const req = {
    method: 'POST',
    body: { name }
  }
 ...
 */
TogglClient.prototype.deleteTag = function deleteTag(workspaceId, tagId, callback) {
  const req = {
    method: 'DELETE'
  };
 ...
 * @param {Function} callback <code>(err, tag)</code>
 */
TogglClient.prototype.updateTagName = function updateTagName(workspaceId, tagId, name,
  callback) {
  const req = {
    method: 'PUT',
    body: { name }
