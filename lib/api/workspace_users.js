 ...
 */
TogglClient.prototype.inviteUsers = function inviteUsers(organizationId, emails, callback) {
  var req = {
    method: 'POST',
    body: {
      emails: emails
  ...
  return this.apiRequest(`organizations/${organizationId}/invitations`, req, onresponse);
 ...
 */
TogglClient.prototype.updateWorkspaceUser = function updateWorkspaceUser(wuId, options, callback) {
  var req = {
    method: 'PUT',
    body: {
