...
TogglClient.prototype.createClient = function createClient(data, workspaceId, callback) {
  ...
  return this.apiRequest(`workspaces/${workspaceId}/clients`, req, callback);
};
...
TogglClient.prototype.getClientData = function getClientData(clientId, workspaceId, callback) {
  return this.apiRequest(`workspaces/${workspaceId}/clients/${clientId}`, {}, callback);
};
 ...
 */
TogglClient.prototype.getClientProjects = function getClientProjects(clientId, active, callback) {
  var qs = {
    active: active
  };
 ...
 * @param {Function} callback <code>(err, clientData)</code>
 */
TogglClient.prototype.updateClient = function updateClient(clientId, data, workspaceId, callback) {
  var req = {
    method: 'PUT',
    body: {
      client: data
