 ...
 */
TogglClient.prototype.addProjectUser = function addProjectUser(projectId, userId, workspaceId, options,
  fields, callback) {
 ...
 */
TogglClient.prototype.addProjectUsers = function addProjectUsers(projectId, userIds, options,
  fields, callback) {
 ...
 */
TogglClient.prototype.deleteProjectUser = function deleteProjectUser(puID, workspaceId, callback) {
  const req = {
    method: 'DELETE'
  };
 ...
 * @param {Function} callback <code>(err)</code>
 */
TogglClient.prototype.deleteProjectUsers = function deleteProjectUsers(puIDs, callback) {
 ...
 * @param {Function} callback <code>(err, projectUser)</code>
 */
TogglClient.prototype.updateProjectUser = function updateProjectUser(puID, workspaceId, options, fields, callback) {
  if (arguments.length === 3) {
    callback = fields;
    fields = null;
  }
 ...
 * @param {Function} callback <code>(err, projectUsers)</code>
 */
TogglClient.prototype.updateProjectUsers = function updateProjectUsers(puIDs, options, fields,
  callback) {
  var args = utils.args(arguments);
  args[0] = puIDs.join();
  callback = args.pop();
