...
TogglClient.prototype.addProjectUser = function addProjectUser(projectId,
  ...
  return this.apiRequest(`/api/v9/workspaces/${workspaceId}/project_users`, req,
...
TogglClient.prototype.deleteProjectUser = function deleteProjectUser(puID, workspaceId, callback) {
  ...
  return this.apiRequest(`/api/v9/workspaces/${workspaceId}/project_users/${puID}`, req, callback);
};
 ...
 * @param {Function} callback <code>(err, projectUser)</code>
 */
TogglClient.prototype.updateProjectUser = function updateProjectUser(puID, workspaceId,
  ...
  return this.apiRequest(`/api/v9/workspaces/${workspaceId}/project_users/${puID}`, req,
    utils.wrapDataCallback(callback));
};
