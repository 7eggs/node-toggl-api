 ...
 */
TogglClient.createUser = function createUser(email, password, timezone, callback) {
 ...
 */
TogglClient.prototype.changeUserPassword = function changeUserPassword(currentPassword, password, callback) {
