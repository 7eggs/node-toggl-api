...
/**
 * Since almost every call to User API returns "data" object
 * we need to wrap callback so it gets only user data
 *
 * @param {function} callback Accepts arguments: (err, userData)
 */
function wrapDataCallback(callback) {
...
TogglClient.createUser = function(email, password, timezone, callback) {
  ...
  TogglClient.defaultClient().apiRequest('/api/v8/signups', req, wrapDataCallback(callback))
}
...
TogglClient.prototype.changeUserPassword = function(currentPassword, password, callback) {
  ...
  this.apiRequest('/api/v8/me', req, wrapDataCallback(callback))
}
...
TogglClient.prototype.getUserData = function(options, callback) {
  ...
  this.apiRequest('/api/v8/me', {qs: options}, wrapDataCallback(callback))
}
 ...
 */
TogglClient.prototype.setUserData = function(data, callback) {
