...
TogglClient.prototype.createTimeEntry = function createTimeEntry(data,
  ...
  return this.apiRequest('/api/v9/me/time_entries', req,
...
TogglClient.prototype.deleteTimeEntry = function deleteTimeEntry(teId, workspaceId,
  ...
  return this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teId}`, req, callback);
};
...
TogglClient.prototype.getTimeEntryData = function getTimeEntryData(teId,
  callback) {
  return this.apiRequest('/api/v9/me/time_entries/' + teId, {},
    utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.getTimeEntries = function getTimeEntries(startDate,
  ...
  return this.apiRequest('/api/v9/me/time_entries', req, callback);
};
...
TogglClient.prototype.getCurrentTimeEntry = function getCurrentTimeEntry(callback) {
  return this.apiRequest('/api/v9/me/time_entries/current', {},
    utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.startTimeEntry = function startTimeEntry(data, callback) {
  ...
  return this.apiRequest(`/api/v9/workspaces/${data.workspace_id}/time_entries`,
    req,
    utils.wrapDataCallback(callback))
};
...
TogglClient.prototype.stopTimeEntry = function stopTimeEntry(workspaceId, teId, callback) {
  ...
  return this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teId}/stop`,
...
TogglClient.prototype.updateTimeEntry = function updateTimeEntry(teId, workspaceId, data,
  ...
  return this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teId}`, req,
    utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.updateTimeEntriesTags = function updateTimeEntriesTags(teIds, workspaceId,
  ...
  return this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teIds.join()}`, req,
    utils.wrapDataCallback(callback));
};
