...
TogglClient.prototype.createTimeEntry = function createTimeEntry(data,
  ...
  this.apiRequest('/api/v9/me/time_entries', req,
 ...
 */
TogglClient.prototype.deleteTimeEntry = function deleteTimeEntry(teId, workspaceId,
  callback) {
  const req = {
    method: 'DELETE'
  };

  this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teId}`, req, callback);
};
...
TogglClient.prototype.getTimeEntryData = function getTimeEntryData(teId,
  callback) {
  this.apiRequest('/api/v9/me/time_entries/' + teId, {},
    utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.getTimeEntries = function getTimeEntries(startDate,
  ...
  this.apiRequest('/api/v9/me/time_entries', req, callback);
};
...
TogglClient.prototype.getCurrentTimeEntry = function getCurrentTimeEntry(callback) {
  this.apiRequest('/api/v9/me/time_entries/current', {},
    utils.wrapDataCallback(callback));
};
 ...
 * @param {Function} callback <code>(err, timeEntry)</code>
 */
TogglClient.prototype.startTimeEntry = function startTimeEntry(workspaceId, data, callback) {
  data.created_with = TogglClient.USER_AGENT;
  ...
  this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries`, req,
    utils.wrapDataCallback(callback));
};
 ...
 * @param {Function} callback <code>(err, timeEntry)</code>
 */
TogglClient.prototype.stopTimeEntry = function stopTimeEntry(teId, workspaceId, callback) {
  const req = {
    method: 'PATCH'
  };

  this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teId}/stop`,
 ...
 * @param {Function} callback <code>(err, timeEntry)</code>
 */
TogglClient.prototype.updateTimeEntry = function updateTimeEntry(teId, workspaceId, data,
  callback) {
  const req = {
    method: 'PUT',
    body: {
  ...
  this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teId}`, req,
    utils.wrapDataCallback(callback));
};
 ...
 * @param {Function} callback <code>(err, timeEntries)</code>
 */
TogglClient.prototype.updateTimeEntriesTags = function updateTimeEntriesTags(teIds, workspaceId,
  ...
  this.apiRequest(`/api/v9/workspaces/${workspaceId}/time_entries/${teIds.join()}`, req,
    utils.wrapDataCallback(callback));
};
