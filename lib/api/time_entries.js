 ...
 * @public
 * @param {String|Number|Date} [startDate] Date range start
 * @param {String|Number|Date} [endDate] Date range end
 ...
 */
TogglClient.prototype.updateTimeEntries = function (workspaceId, teIds, array, callback) {
  const req = {
    method: 'PATCH',
    body: array
  };
 ...
 * @param {Function} callback <code>(err, timeEntry)</code>
 */
TogglClient.prototype.updateTimeEntry = function (workspaceId, teId, data, callback) {
  const req = {
    method: 'PUT',
    body: data
  };
 ...
 */
TogglClient.prototype.deleteTimeEntry = function (workspaceId, teId, callback) {
  const req = {
    method: 'DELETE'
  };
 ...
 * @param {Function} callback <code>(err, timeEntry)</code>
 */
TogglClient.prototype.stopTimeEntry = function (workspaceId, teId, callback) {
  const req = {
    method: 'PATCH'
  };
