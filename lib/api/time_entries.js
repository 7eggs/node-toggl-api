...
TogglClient.prototype.updateTimeEntries = function updateTimeEntries(workspaceId, teIds, array, callback) {
  ...
  return this.apiRequest(`workspaces/${workspaceId}/time_entries/${teIds.join()}`, req, utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.deleteTimeEntry = function deleteTimeEntry(workspaceId, teId,
  ...
  return this.apiRequest(`workspaces/${workspaceId}/time_entries/${teId}`, req, utils.wrapDataCallback(callback));
};
