 ...
 */
TogglClient.prototype.getProjectTasks = function getProjectTasks(projectId, workspaceId, callback) {
 ...
 */
TogglClient.prototype.getProjectUsers = function getProjectUsers(projectId, workspaceId, callback) {
 ...
 * @param {Function} callback <code>(err, projectData)</code>
 */
TogglClient.prototype.updateProject = function updateProject(projectId, workspaceId, data, callback) {
  var req = {
    method: 'PUT',
    body: {
      project: data
